...
def demo(cpus, priority, path, testCount, rounds):
    cmd = "sudo taskset -c " + cpus + " chrt -r " + str(priority) + " " + path + " " + str(testCount) + " " + str(
        rounds)
...
cg_out = demo("13-15", 10, cgraph_binary_path, 1000000, 2)
tf_out = demo("13-15", 10, taskflow_binary_path, 1000000, 2)
cg_z_out = demo("13-15", 10, cgraph_zong_binary_path, 1000000, 2)
tf_z_out = demo("13-15", 10, taskflow_zong_binary_path, 1000000, 2)
